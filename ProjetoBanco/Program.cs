    ...
    public class Program
    {
        static void Main(string[] args)
        {
           ...
           // Console.WriteLine("O valo do seu saldo é R$" + conta1.saldo);
            ...
            Console.WriteLine("Saldo da sua conta antes da tranferência: R$ " + conta1.saldo);
            Console.WriteLine("Saldo da sua conta que irá receber: R$ " + conta2.saldo);

            if (conta1.Transferir(200, conta2))

            Console.WriteLine("\n");

            Console.WriteLine("O valor da sua tranferência foi de: R$ " + conta1.valorTranferencia);
            Console.WriteLine("Seu saldo atual após a tranferência é de: R$ " + conta2.saldo);
